...
const individual_report_test_cases = [
  #([7, 5, 4, 3, 2], True, True), #([2, 3, 4, 5, 7], True, True),
  ...
  #([14, 11, 14, 17, 18, 19], False, True),
]

fn test_individual_report(test_case: #(day02.Report, Bool, Bool)) {
...
pub fn edge_cases_test() {
  individual_report_test_cases |> list.each(test_individual_report)
}
